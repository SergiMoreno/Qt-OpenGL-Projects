...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
  ...
  private:
    ...
    // VAOs
    GLuint VAOCopa[2], VAOTronc;

    // viewport
    GLint ample, alt;

    // info model arbre
    const float offsetBase = 0.8; // Trobeu el valor correcte
    ...
    bool mode; // Variable bool per dibuixar la copa triangular o la quadrada
               // mode = true -> triangular / mode = false -> quadrada
};
